// Source Code adapted from: https://github.com/bhrott/flutter-masked-text
import 'package:flutter/material.dart';

class MaskedTextController extends TextEditingController {
  MaskedTextController({required String text, required this.mask})
      : super(text: text) {
    addListener(() {
